...
public class Encrypt {
	...
	public static void encrypt(String passwordValue) {
		/* Plain text Password. */
		...
		App.passwordEnc = encryptedpassword;
		App.passwordSalt = saltvalue;
	...
	public static Boolean decrypt(String passwordValue, String encryptedpassword, String salt) {

		/* verify the original password and encrypted password */
		Boolean status = PassBasedEnc.verifyUserPassword(passwordValue, encryptedpassword, salt);
